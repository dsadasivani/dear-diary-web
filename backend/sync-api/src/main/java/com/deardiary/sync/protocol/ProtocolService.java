    ...
    public ProtocolResponse current() {
        ...
        return jdbc.queryForObject("""
            ...
            """, (rs, row) -> new ProtocolResponse(
                ...
                rs.getLong(6), rs.getLong(7), rs.getString(19), rs.getInt(20), rs.getInt(21), rs.getBoolean(22),
                new ProtocolResponse.FeatureFlags(
                    rs.getBoolean(8) && !rs.getBoolean(22) && !switches.getOrDefault("SYNC_WRITES", true),
                    rs.getBoolean(9) && !switches.getOrDefault("REMOTE_PULL", true),
                    rs.getBoolean(10) && !rs.getBoolean(22) && !switches.getOrDefault("REALTIME", true),
                    rs.getBoolean(11) && !rs.getBoolean(22) && !switches.getOrDefault("SNAPSHOT_CREATION", true),
                    rs.getBoolean(12) && !rs.getBoolean(22) && !switches.getOrDefault("GARBAGE_COLLECTION", true),
                    rs.getBoolean(14) && !rs.getBoolean(22) && !switches.getOrDefault("MEDIA_UPLOAD", true),
                    rs.getBoolean(15) && !rs.getBoolean(22) && !switches.getOrDefault("ARCHIVE_HYDRATION", true),
                    rs.getBoolean(13) && !rs.getBoolean(22) && !switches.getOrDefault("KEY_ROTATION", true),
                    rs.getBoolean(16) && !rs.getBoolean(22) && !switches.getOrDefault("DEVICE_REVOCATION", true),
                    rs.getBoolean(17) && !rs.getBoolean(22) && !switches.getOrDefault("PRIMARY_RECOVERY", true),
                    rs.getBoolean(18) && !rs.getBoolean(22) && !switches.getOrDefault("COMPANION_PAIRING", true)
                )));
    }
}
