...
export interface SyncBackgroundWorker {
  start(): void | Promise<void>;
  stop(): void | Promise<void>;
}

export class SyncRuntimeCoordinator {
  ...
  constructor(
    ...
    private readonly pullWorker: SyncBackgroundWorker,
    private readonly outboxWorker: SyncBackgroundWorker,
    private readonly maintenanceWorker?: SyncBackgroundWorker,
  ) {}
