...
import type { OutboxRepository, SyncOperation } from '../../outbox';
import type { SyncConflictRecorder } from '../operation/SyncOperationProcessor';

const STORAGE_KEY = 'deardiary_sync_conflicts';
...
export class PersistentSyncConflictStore implements SyncConflictRecorder {
