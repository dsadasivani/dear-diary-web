...
export class SyncPairingCoordinator {
  constructor(
    ...
    private readonly transfer: {
      upload(bytes: Uint8Array, instruction: SyncUploadInstruction): Promise<void>;
      download(
        pairing: Pick<SyncPairing, 'downloadUrl' | 'sha256' | 'sizeBytes'>,
      ): Promise<Uint8Array>;
    },
  ...
  async complete(afterComplete?: (pairing: SyncPairing) => Promise<void>): Promise<void> {
...
export class SyncRotationCoordinator {
  constructor(
